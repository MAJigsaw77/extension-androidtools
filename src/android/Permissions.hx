...
class Permissions
{
	...
	{
		var getGrantedPermissionsJNI:Dynamic = JNI.createStaticMethod("android/haxe/androidtools/Permissions", "getGrantedPermissions", "()[Ljava/lang/String;");
	...
	{
		var requestPermissionsJNI:Dynamic = JNI.createStaticMethod("android/haxe/androidtools/Permissions", "requestPermissions", "([Ljava/lang/String;I)V");
