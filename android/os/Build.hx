...
class Build
{
	public static var TAG(get, never):String = 'Build';

	/**
	 * Value used for when a build property is unknown..
	 */
	public static var UNKNOWN(get, never):String = 'unknown';

	/**
	 * The name of the underlying board, like 'goldfish'.
	 */
	public static var BOARD(get, never):String = JNI.createStaticField('android/os/Build', 'BOARD', 'Ljava/lang/String;').get();

	/**
	 * The consumer-visible brand with which the product/hardware will be associated, if any.
	 */
	public static var BRAND(get, never):String = JNI.createStaticField('android/os/Build', 'BRAND', 'Ljava/lang/String;').get();

	/**
	 * The name of the industrial design.
	 */
	public static var DEVICE(get, never):String = JNI.createStaticField('android/os/Build', 'DEVICE', 'Ljava/lang/String;').get();

	public static var HOST(get, never):String = JNI.createStaticField('android/os/Build', 'HOST', 'Ljava/lang/String;').get();

	/**
	 * Either a changelist number, or a label like 'M4-rc20'.
	 */
	public static var ID(get, never):String = JNI.createStaticField('android/os/Build', 'ID', 'Ljava/lang/String;').get();

	/**
	 * The name of the overall product.
	 */
	public static var PRODUCT(get, never):String = JNI.createStaticField('android/os/Build', 'PRODUCT', 'Ljava/lang/String;').get();

	/**
	 * The manufacturer of the product/hardware.
	 */
	public static var MANUFACTURER(get, never):String = JNI.createStaticField('android/os/Build', 'MANUFACTURER', 'Ljava/lang/String;').get();

	/**
	 * The end-user-visible name for the end product.
	 */
	public static var MODEL(get, never):String = JNI.createStaticField('android/os/Build', 'MODEL', 'Ljava/lang/String;').get();

	public static var USER(get, never):String = JNI.createStaticField('android/os/Build', 'USER', 'Ljava/lang/String;').get();
...
class VERSION
{
	 ...
	 */
	public static var CODENAME(get, never):String = JNI.createStaticField("android/os/Build$VERSION", 'CODENAME', 'Ljava/lang/String;').get();

	/**
	 * The internal value used by the underlying source control to represent this build.
	 * E.g., a perforce changelist number or a git hash.
	 */
	public static var INCREMENTAL(get, never):String = JNI.createStaticField("android/os/Build$VERSION", 'INCREMENTAL', 'Ljava/lang/String;').get();

	/**
	 * The user-visible version string.
	 */
	public static var RELEASE(get, never):String = JNI.createStaticField("android/os/Build$VERSION", 'RELEASE', 'Ljava/lang/String;').get();

	/**
	 * The user-visible SDK version of the framework in its raw String representation; use SDK_INT instead.
	 */
	public static var SDK(get, never):String = JNI.createStaticField("android/os/Build$VERSION", 'SDK', 'Ljava/lang/String;').get();

	/**
	 * The SDK version of the software currently running on this hardware device.
	 */
	public static var SDK_INT(get, never):Int = JNI.createStaticField("android/os/Build$VERSION", 'SDK_INT', 'I').get();
}
