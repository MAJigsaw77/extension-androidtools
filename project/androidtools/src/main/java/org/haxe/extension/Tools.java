...
/**
 * You can use the Android Extension class in order to hook into the Android activity lifecycle.
 * This is not required for standard Java code, this is designed for when you need deeper integration.
 *
 * You can access additional references from the Extension class, depending on your needs:
